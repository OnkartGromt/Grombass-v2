...
void loop() {
  ...
  EXPon = digitalRead(EXP_ON);  //Active load
  ...
  } else if ((Tap1Timer > 75) && ExpRange != EEPROM.read(4)) { //Write to EEPROM once when button is released
    EEPROM.write(4, ExpRange);
    Serial.print("ExpRange: ");
    Serial.println(ExpRange);
  }
